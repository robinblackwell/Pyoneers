...
def main():
    ...
    def spawn_arena_enemy(): # a dedicated spawn function for the arena battle - allows variability
        ...
        if boss_spawn == True:
            ...
            if current_time > last_minion + 4000:
            ...
            def posEnemy(classTypeX, x, classTypeY, y):
                classTypeX = x
                classTypeY = y
            ...
            if kill_count < 6:
                ...
                if enemy_spawnpoint == 1:
                    ...
                    if enemy_type == 1:
                        enemy02 = Enemy03()
                        posEnemy(enemy02.rect.x, 300, enemy02.rect.y, 150)
                    else:  
                        enemy02 = Enemy01()
                        enemy02.rect.x = 100
                        enemy02.rect.y = 150
    ...
    while not done:
        ...
        if current_level_no == 1:
            current_time = pygame.time.get_ticks() # currently getting time every loop when in arena
